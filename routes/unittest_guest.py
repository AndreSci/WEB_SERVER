...
def unblock_guest():
    ...
    if not ALLOW_IP.find(user_ip, LOGGER):
        ...
        if request.is_json:
            ...
            json_replay = CreateGuestDB.unblock_guest(json_request.get('FAccountID'), json_request.get('FID'))
...
def delete_guest():
    ...
    if not ALLOW_IP.find(user_ip, LOGGER):
        ...
        if request.is_json:
            ...
            json_replay = CreateGuestDB.delete_guest(json_request.get('FAccountID'), json_request.get('FID'))
